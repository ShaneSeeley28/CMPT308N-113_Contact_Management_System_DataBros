...
class MainMenu:
    ...
    def show_add_contact_page(self):
        ...
        add_contact_window.geometry("400x300")
    ...
    def show_remove_contact_page(self):
        ...
        remove_contact_window.geometry("400x300")
    ...
    def show_about_us_page(self):
        ...
        about_us_window.geometry("400x300")
...
def validate_login(username, password, login_window):
    try:
        ...
        if user and verify_password(password, user[1]):  # Assuming the hashed password is stored in the second column
...
def login():
    ...
    if not username or not password:
        messagebox.showwarning("Incomplete Input", "Please enter both username and password.")
        return
